...
::: {style="color: blue;"}
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *dataExplorer*[@DataExplorer] fornece a função *create_report* para executar análise exploratória. [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://cran.r-project.org/web/packages/DataExplorer/index.html)
:::

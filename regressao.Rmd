...
::: blue
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *fastDummies*[@fastDummies] fornece a funçãao *dummy_cols* para preparar as variáveis categóricas fictícias para análise de regressão. [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://cran.r-project.org/web/packages/fastDummies/index.html)
:::

...
-   Kendall $\tau$.[@khamis2008; @allison2022]
    ...
    -   O coeficiente Kendall $\tau$ é definido como a porporção de todos os pares concordantes menos a proporção de todos os pares discordantes.[@khamis2008; @allison2022]
...
::: blue
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *stats*[@stats-2] fornece a função *cor.test* para calcular o coeficiente Kendall $\tau$ [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://rdocumentation.org/packages/stats/versions/3.6.2)
:::

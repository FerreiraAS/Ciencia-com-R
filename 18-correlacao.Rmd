...
::: blue
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *stats*[@stats-2] fornece a função *cor.test* para calcular o coeficiente de correlação de Pearson ($r$). [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://rdocumentation.org/packages/stats/versions/3.6.2)
:::
...
-   Coeficiente de correlação ponto-bisserial ($r_{s}$).[@khamis2008]
    ...
    -   O coeficiente de correlação ponto-bisserial ($r_{s}$) avalia a força e direção da relação linear entre uma variáveis quantitativas e outra dicotômica.[@khamis2008]
...
::: blue
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *stats*[@stats-2] fornece a função *cor.test* para calcular o coeficiente de correlação ponto-bisserial ($r_{s}$). [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://rdocumentation.org/packages/stats/versions/3.6.2)
:::
...
::: blue
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *stats*[@stats-2] fornece a função *cor.test* para calcular o coeficiente de correlação de Speaman $\rho$. [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://rdocumentation.org/packages/stats/versions/3.6.2)
:::

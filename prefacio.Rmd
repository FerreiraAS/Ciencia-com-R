...
O objetivo geral de cada capítulo é elucidar questões fundamentais: *“O que é?”*, *“Por que usar?”*, *“Quando usar?”*, *“Quando não usar?”* e *“Como fazer?”*. Em cada capítulo, questões específicas são propostas e respondidas sistematicamente, permitindo uma maior elaboração do conteúdo.

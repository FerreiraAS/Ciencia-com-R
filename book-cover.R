...
for(i in 1:2){
  ...
  # book title
  text(x = W, y = H/1.5 + 0.5, labels = "Ciência com R", pos = 2, cex = 4, col = "white")

  # book subtitle
  text(x = W, y = H/1.5, labels = substitute(paste(italic("Perguntas e respostas para pesquisadores e analistas de dados"))), pos = 2, cex = 1.5, col = "white")

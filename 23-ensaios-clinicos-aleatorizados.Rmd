...
- A característica essencial de um ensaio clínico randomizado é a comparação entre grupos.[@bland2011]
...
### Por que não se deve comparar intragrupos (pré-pós) em ensaios clínicos randomizados?

-    Testar por mudanças a partir da linha de base separadamente em cada grupos randomizados não permite concluir sobre diferenças entre grupos; não se pode fazer inferências a partir da comparação de p-valores.[@bland2011]

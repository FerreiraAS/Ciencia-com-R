...
-   Coeficiente de determinação ($R^2$) \@ref(eq:r2) e $RR^2_{ajustado}$ \@ref(eq:r2adj): Medem a proporção da variabilidade dos dados explicada pelo modelo. O $R^2$ ajustado penaliza a inclusão de variáveis irrelevantes.[@Kim2019]

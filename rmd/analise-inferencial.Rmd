...
-   Teste de mínimos efeitos: testa se o efeito é pelo menos tão grande quanto um limiar de relevância (SESOI). Rejeitar $H_{0}$ sugere efeito grande o suficiente.[@lakens2018]

-   Teste de equivalência ou dois testes unicaudais (*Two One-Sided Tests*, TOST): testa se o efeito está dentro de uma margem de equivalência clinicamente irrelevante (entre $\Delta$ e $-\Delta$). Rejeitar $H_{0}$ sugere equivalência prática.[@lakens2018]

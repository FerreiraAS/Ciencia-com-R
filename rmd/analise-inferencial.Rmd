...
O pacote *infer*[@infer] fornece a função `specify` para especificar as variáveis ou a relação entre elas.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *infer*[@infer] fornece a função `hypothesize` para especificar a hipótese nula.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *infer*[@infer] fornece a função `generate` para gerar reamostras, permutações ou simulações.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *infer*[@infer] fornece a função `calculate` para calcular estatísticas sumárias.
:::
...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *stats*[@stats] fornece a função `p.adjust` para ajustar o P-valor utilizando diversos métodos.
:::

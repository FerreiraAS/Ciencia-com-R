...
-   Qual é a direção do efeito?[@mccaskey2015]

-   Qual é a magnitude do efeito?[@mccaskey2015]

-   Qual é a importância do efeito?[@mccaskey2015]
...
-   Resultados 'negativos' ou inconclusivos compreendem um P-valor fora da zona crítica estatisticamente significativa (ex.: P ≥ 0,05 ou outro ponto de corte) e sugerem que os autores não rejeitem a hipótese nula $H_{0}$ porque o efeito observado é nulo (logo, *negativo*), ou porque o estudo não possui poder suficiente para detectá-lo, não permitindo portanto afirmar a hipótese científica (logo, *inconclusivo*).[@greenhalgh1997a]

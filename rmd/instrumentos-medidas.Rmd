...
target_board <- function(title) {
  plot(0, 0, cex = 24, pch = 21, bg = "grey", col = "black", axes = F, main = title, xlab = NA, ylab = NA)
  points(0, 0, cex = 21, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 18, pch = 21, bg = "grey", col = "grey")
  points(0, 0, cex = 15, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 12, pch = 21, bg = "grey", col = "grey")
  points(0, 0, cex = 9, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 6, pch = 21, bg = "grey", col = "grey")

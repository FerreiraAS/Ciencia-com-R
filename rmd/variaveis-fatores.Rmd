...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *stats*[@stats] fornece a função [*model.matrix*](https://www.rdocumentation.org/packages/stats/versions/3.5.2/topics/model.matrix) para expandir variáveis categóricas em variáveis indicadoras.
:::

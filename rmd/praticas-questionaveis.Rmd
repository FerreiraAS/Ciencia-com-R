...
- *Post-publication peer review* é a prática de revisar e discutir criticamente publicações, permitindo identificar erros, inconsistências metodológicas e problemas éticos.[@knoepfler2015; @teixeiradasilva2016]
...
- *Expression of concern* é uma manifestação emitida por periódicos para alertar os leitores sobre possíveis problemas relacionados à integridade, confiabilidade ou ética de um estudo.[@teixeiradasilva2016]

- *Retraction* é a retirada formal de uma publicação científica quando há evidências de resultados não confiáveis, erro grave, má conduta científica, plágio, duplicação indevida ou pesquisa antiética.[@teixeiradasilva2016]
...
O pacote *retractcheck*[@retractcheck] fornece a função `retractcheck` para verificar se um artigo foi retratado.
:::

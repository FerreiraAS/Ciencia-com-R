...
- *Post-publication peer review* é a prática de revisar e discutir criticamente publicações após sua divulgação, permitindo identificar erros, inconsistências metodológicas e problemas éticos não detectados na revisão por pares.[@knoepfler2015; @teixeiradasilva2016]

- *Corrigendum* é uma correção publicada para ajustar erros atribuídos aos autores em um artigo, sem comprometer necessariamente as conclusões centrais do estudo. Seu objetivo é preservar a integridade e a precisão do registro científico.[@teixeiradasilva2016]
...
- *Expression of concern* é uma manifestação emitida por periódicos para alertar os leitores sobre possíveis problemas relacionados à integridade, confiabilidade ou ética de um estudo, especialmente quando ainda há investigações em andamento ou evidências inconclusivas.[@teixeiradasilva2016]

- *Retraction* é a retirada formal de uma publicação científica quando há evidências de resultados não confiáveis, erro grave, má conduta científica, plágio, duplicação indevida ou pesquisa antiética. O objetivo principal é corrigir a literatura e preservar a confiabilidade do registro acadêmico.[@teixeiradasilva2016]

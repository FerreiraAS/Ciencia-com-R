...
-   Informar: o número de participantes com dados perdidos; diferenças nas taxas de dados perdidos entre os braços do estudo; os motivos dos dados perdidos; quaisquer diferenças entre os participantes com e sem dados perdidos; o padrão de perda; os métodos para tratamento de dados perdidos das variáveis em análise; os resultados de análises de sensibilidade; as implicações dos dados perdidos na interpretação do resultados.[@Akl2015]

...
### Que estratégias utilizar na redação de estudos em que há dados perdidos?

-   Informar: número de participantes com dados perdidos poe variável; diferenças nas taxas de dados perdidos entre os braços do estudo; motivos dos dados perdidos; diferenças entre os participantes com e sem dados perdidos; padrão de perda; métodos para tratamento de dados perdidos; resultados de análises de sensibilidade; implicações na interpretação do resultados.[@Akl2015]

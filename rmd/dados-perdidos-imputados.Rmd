...
```{r mcar, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Representação gráfica de dados perdidos completamente ao acaso (MCAR) em um estudo randomizado controlado (RCT)."}
...
```{r mar, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Representação gráfica de dados perdidos ao acaso (MAR) em um estudo randomizado controlado (RCT)."}
# para reproduzir o exemplo
set.seed(123)
...
```{r mnar, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Representação gráfica de dados perdidos não ao acaso (MNAR) em um estudo randomizado controlado (RCT)."}
# para reproduzir o exemplo
set.seed(123)

...
```{r tabela-0, include = TRUE, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE}
...
```{r tabela-0-long, include = TRUE, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE}
# parâmetros
N <- 5
M <- 4
...
kableExtra::kable(
  ...
  linesep = "",
  escape = F,
  caption = "Formato longo para medidas repetidas (múltiplas linhas por sujeito; colunas = variáveis)"
) %>%
  kableExtra::kable_styling(
    latex_options = c("striped"),
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
...
```{r tabela-0-wide, include = TRUE, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE}
# Reproducibilidade
set.seed(1)
...
kableExtra::kable(
  ...
  caption = "Formato largo para medidas repetidas (1 variável; colunas = tempos)"
) %>%
...
```{r tabela-recomendada, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE}
# cria a tabela de exemplos
table.final <-
...
```{r tabela-evite, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE}
# cria a tabela de exemplos
table.final <-

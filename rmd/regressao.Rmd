...
- Modelos lineares (equação \@ref(eq:regressao-linear)) descrevem uma relação linear nos parâmetros entre um desfecho contínuo $Y$ e um ou mais preditores $X$.[@REF]

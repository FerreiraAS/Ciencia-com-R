...
### O que são análises de regressão Lasso?
...
-   (equação \@ref(eq:regressao-logistica)) .[@REF]

\begin{equation}
(\#eq:regressao-logistica)
\log\left(\frac{p}{1-p}\right) = \beta_0 + \beta_1 X + ... + \beta_n X_n + \epsilon
\end{equation}
...
### O que são análises de regressão de Poisson?

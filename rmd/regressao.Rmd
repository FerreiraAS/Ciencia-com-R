...
ggplot2::ggplot(data, ggplot2::aes(x = X, y = Y)) +
  ...
  ggplot2::labs(title = "Regressão linear", x = "Variável Independente (X)", y = "Variável Dependente (Y)") +
...
ggplot2::ggplot(data, ggplot2::aes(x = X, y = Y)) +
  ...
  ggplot2::geom_smooth(method = "lm",
                       formula = y ~ poly(x, 2),
                       color = "blue") +
  ggplot2::labs(title = "Regressão não-linear", x = "Variável Independente (X)", y = "Variável Dependente (Y)") +
  ggplot2::theme_minimal()
```
...
```{r multicolinearidade, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Multicolinearidade entre variáveis candidatas em modelos de regressão multivariável."}

...
- Embora os testes de hipótese considerem efeito nulo para a hipótese nula --- ex.: $H_{0}: \mu_{1} - \mu_{2}=0$, $H_{0}: r=0$), $H_{0}: \beta=0$) ---, em geral é improvável que os efeitos populacionais sejam de fato nulos (isto é, exatamente 0).[@Andrade2020]

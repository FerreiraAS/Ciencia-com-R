...
```{r reamostragem, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Representação esquemática da reamostragem de uma amostra."}
# reproducibilidade
set.seed(123)
...
```{r subamostragem, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Representação esquemática da subamostragem de uma amostra."}
# Reprodutibilidade
set.seed(123)
...
```{r superamostragem, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Representação esquemática da superamostragem de uma população."}
# Reprodutibilidade
set.seed(123)

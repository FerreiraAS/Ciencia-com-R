...
- Quando a amostra contém menos indivíduos do que o número mínimo necessário, mas mantém a representatividade, a inferência estatística ainda é possível, embora possa haver redução da precisão e/ou do poder estatístico para detectar os efeitos.[@martinez-mesa2016]
...
-   Não-probabilísticas ou intencionais:[@Banerjee2010; @martinez-mesa2016]
...
-   Probabilísticas:[@Banerjee2010; @martinez-mesa2016]

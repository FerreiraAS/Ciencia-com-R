...
O pacote *gtsummary*[@gtsummary] fornece a função `tbl_summary` para construção da 'Tabela 1' com dados descritivos.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *table1*[@table1] fornece a função `table1` para construção de tabelas.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *flextable*[@flextable] fornece as funções `flextable`, `as_flextable` e `save_as_docx` para criar e salvar tabelas formatadas em DOCX.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *rempsyc*[@rempsyc] fornece a função `nice_table` para criar tabelas formatadas.
:::
...
```{r tabela-2, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Tabela suscetível à Falácia da Tabela 2. A tabela apresenta a razão de chances (OR) bruta entre grupo e sexo (modelo sem covariáveis) e ajustada entre grupo e sexo, controlando por idade e IMC (modelo com covariáveis)."}
library(dplyr)
...
```{r falacia-tabela-2, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Tabela suscetível à falácia da Tabela 2. A tabela apresenta a razão de chances (OR) bruta entre grupo e sexo (modelo sem covariáveis)e a OR ajustada entre grupo e sexo, controlando por idade e IMC (modelo com covariáveis)."}
library(dplyr)
...
tab_falacia <- gtsummary::tbl_merge(
  ...
  gtsummary::modify_caption("Tabela suscetível à Falácia da 'Tabela 2'.")

...
-   `r R.version$version.string` está disponível gratuitamente em [Comprehensive R Archive Network (CRAN)]((https://cran.r-project.org)).
...
-   O ambiente do RStudio é dividido em paineis:
    ...
    -   *Editor*: para edição de R scripts.[@introduc2020]

    -   *Environment*: para visualização de objetos criados durante a sessão de trabalho.[@introduc2020]

    -   *Plots*: para visualização de gráficos criados durante a sessão de trabalho.[@introduc2020]
...
-   Na mais recente atualização deste livro, o [Comprehensive R Archive Network (CRAN)]((https://cran.r-project.org)) possui `r length(utils::available.packages(repos = "http://cran.us.r-project.org"))` pacotes disponíveis.[@introduc2020]
...
-   Escolha uma [licença](https://chooser-beta.creativecommons.org) apropriada para garantir como outros usarão seus scripts.[@Eglen2017]
...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *utils*[@utils] fornece a função [*sessionInfo*](https://www.rdocumentation.org/packages/utils/versions/3.6.2/topics/sessionInfo) para obter informações sobre a sessão atual incluindo a versão do R, o sistmea operacional e os pacotes carregados.
:::

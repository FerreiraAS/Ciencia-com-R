...
```{r rstudio-interface, echo = FALSE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), fig.cap = "Interface do RStudio. Fonte: https://docs.posit.co/ide/user/"}

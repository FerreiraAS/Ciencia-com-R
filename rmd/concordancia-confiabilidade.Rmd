...
-   Coeficiente de correlação biserial $r_{s}$.[@banerjee1999]

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *psych*[@psych] fornece a função [*tetrachoric*](https://www.rdocumentation.org/packages/psych/versions/2.3.6/topics/tetrachoric) para calcular o coeficiente de correlação biserial ($r_{s}$).
:::

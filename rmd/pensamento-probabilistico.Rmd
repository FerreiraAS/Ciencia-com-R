...
```{r independencia-venn, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Superior: Eventos independentes. Inferior: Eventos dependentes.", results = FALSE}

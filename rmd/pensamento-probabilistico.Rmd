...
```{r espaco-amostral-dado, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Exemploes de espaço amostral discreto. Superiro: Todas as faces de uma moeda. Inferior: Todas as faces de um dado. "}
# para reprodutibilidade
set.seed(1234)

# simula o lançamento de moeda
população <- tidydice::flip_coin(
        times = 1000,
        rounds = 1,
        success = 4)
...
```{r teoroma-central-limite-numerica, include = FALSE, echo = FALSE, results = "hide"}
...
```{r teoroma-central-limite-dado, include = FALSE, echo = FALSE, results = "hide"}
# para garantir a reprodutibilidade
set.seed(1234)
...
```{r teoroma-central-limite-moeda, include = FALSE, echo = FALSE, results = "hide"}
# para garantir a reprodutibilidade
set.seed(1234)
...
-   Regressão para a média[@galton1886] é um fenômeno estatístico que ocorre quando uma variável aleatória $Y$ é medida da mesma unidade de análise em dois ou mais momentos diferentes, $Y_{1}$, $Y_{2}$, ..., $Y_{t}$, e a média de $Y_{t}$ é mais próxima da média populacional do que $Y_{1}$, ou seja, $E(Y_{t})$ é mais próxima de $E(Y)$ do que $E(Y_{1})$ é de $E(Y)$.[@barnett2004]

...
- O valor agregado será considerado representativo da variável para a unidade de análise (ex.: média = **`r round(VAR.aggr[k2], digits = 0)` mmHg** para o participante **\#`r k2`**).[REF]
...
target_board <- function(title) {
  plot(0, 0, cex = 24, pch = 21, bg = grDevices::gray(level = 0.6, alpha = 1), col = "black", axes = F, main = title, xlab = NA, ylab = NA)
  points(0, 0, cex = 21, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 18, pch = 21, bg = grDevices::gray(level = 0.5, alpha = 1), col = grDevices::gray(level = 0.5, alpha = 1))
  points(0, 0, cex = 15, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 12, pch = 21, bg = grDevices::gray(level = 0.4, alpha = 1), col = grDevices::gray(level = 0.4, alpha = 1))
  points(0, 0, cex = 9, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 6, pch = 21, bg = grDevices::gray(level = 0.3, alpha = 1), col = grDevices::gray(level = 0.3, alpha = 1))
...
```{r vies-variabilidade, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.cap = "Acurácia e precisão como propriedades de uma medida."}
...
# target board function
target_board <- function(title) {
  plot(0, 0, cex = 31, pch = 21, bg = grDevices::gray(level = 0.6, alpha = 1), col = "black", axes = F, main = title, xlab = NA, ylab = NA)
  points(0, 0, cex = 27, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 23, pch = 21, bg = grDevices::gray(level = 0.5, alpha = 1), col = grDevices::gray(level = 0.5, alpha = 1))
  points(0, 0, cex = 19, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 15, pch = 21, bg = grDevices::gray(level = 0.4, alpha = 1), col = grDevices::gray(level = 0.4, alpha = 1))
  points(0, 0, cex = 11, pch = 21, bg = "white", col = "white")
  points(0, 0, cex = 7, pch = 21, bg = grDevices::gray(level = 0.3, alpha = 1), col = grDevices::gray(level = 0.3, alpha = 1))
  points(0, 0, cex = 3, pch = 21, bg = "white", col = "white")
}

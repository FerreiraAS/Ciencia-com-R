...
target_board <- function(title) {
  plot(
    ...
    cex = 24,
    pch = 21,
    bg = grDevices::gray(level = 0.8, alpha = 1),
    col = "black",
    axes = F,
    main = title,
    xlab = NA,
  ...
  points(
    ...
    cex = 18,
    pch = 21,
    bg = grDevices::gray(level = 0.7, alpha = 1),
    col = grDevices::gray(level = 0.7, alpha = 1)
  )
  points(
    0,
    0,
  ...
  points(
    ...
    cex = 12,
    pch = 21,
    bg = grDevices::gray(level = 0.6, alpha = 1),
    col = grDevices::gray(level = 0.6, alpha = 1)
  )
  points(
    0,
    0,
  ...
  points(
    ...
    cex = 6,
    pch = 21,
    bg = grDevices::gray(level = 0.5, alpha = 1),
    col = grDevices::gray(level = 0.5, alpha = 1)
  )
  points(
    0,
    0,

...
- Cada item apresenta um conjunto ordenado de categorias de resposta, tipicamente com 5 ou 7 pontos, variando de extremos como “discordo totalmente” a “concordo totalmente”. Cada resposta é associada a um valor numérico (por exemplo, 1 a 5), permitindo a quantificação das respostas.[@norman2010a]
...
- Do ponto de vista teórico, as escalas Likert são classificadas como ordinais, pois indicam uma ordem entre as categorias, mas não garantem que as distâncias entre elas sejam iguais.[@norman2010a]
...
- Evidências empíricas indicam que análises baseadas em médias, como testes t, ANOVA e regressão, são robustas mesmo quando aplicadas a dados de escalas Likert, especialmente em amostras moderadas ou grandes.[@norman2010a]

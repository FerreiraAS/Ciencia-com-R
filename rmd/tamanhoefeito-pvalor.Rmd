...
```{r sgpv, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, tab.cap = "Comparação entre p-valor (bicaudal, inferido do IC 95\\%) e SGPV ($p_{\\delta}$) nos cenários simulados."}
# --- Função SGPV ---
sgpv <- function(I, H0) {

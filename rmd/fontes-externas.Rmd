...
### Quais diretrizes (*guidelines*) estão disponíveis?
...
### Por que usar listas de verificação?

-   Listas de verificação (*checklists*) têm sido recomendados para melhorar o relato das análises realizadas, aumentar a transparência do estudo e reprodutibilidade dos achados.[@Gardner1986]
...
-   Listas de verificação  não são suficientes para garantir a qualidade técnica da pesquisa, mas podem contribuir para a revisão por pares.[@Mascha2017]

<br>

### Quais listas de verificação (*chcklists*) estão disponíveis?

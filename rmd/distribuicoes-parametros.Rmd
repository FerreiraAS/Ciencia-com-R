...
d1 <- ggfortify::ggdistribution(dnorm,
                                ...
                                mean = 0,
                                sd = 1,
                                main = "NORMAL: Distribuição de probabilidade") + ggplot2::scale_y_continuous(labels = scaleFUN) + ggplot2::theme_minimal() + ggplot2::theme(aspect.ratio = 1)

p1 <- ggfortify::ggdistribution(pnorm,
                                seq(-3, 3, 0.1),
                                mean = 0,
                                sd = 1,
                                main = "NORMAL: Função de distribuição cumulativa") + ggplot2::scale_y_continuous(labels = scaleFUN) + ggplot2::theme_minimal() + ggplot2::theme(aspect.ratio = 1)

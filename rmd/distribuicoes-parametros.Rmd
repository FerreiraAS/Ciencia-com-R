...
```{r distribuicao-histograma, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Histogramas com diferentes métodos de binning.: Sturges, Scott e Freedman-Diaconis."}
# Reprodutibilidade
set.seed(123)
...
```{r distribuicoes-parametros, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Parâmetros de distribuição: Assimetria e Curtose."}
# Reprodutibilidade
set.seed(123)
...
```{r curtose, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Parâmetros de distribuição: Curtose em distribuições simétricas (normal vs. uniforme)."}
# Reprodutibilidade
set.seed(123)

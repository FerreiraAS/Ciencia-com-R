...
```{r distribuicao-discreta, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições discretas e suas funções de probabilidade."}
...
bernoulli_data <- rbinom(1000, 1, 0.5) # 1000 testes com probabilidade de sucesso 0.5
p1 <- ggplot2::ggplot(data.frame(bernoulli_data), ggplot2::aes(x = bernoulli_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Bernoulli (p = 0.5)", x = "Resultado", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )

# 2. Distribuição Binomial (n = 10, p = 0.5)
binomial_data <- rbinom(1000, 10, 0.5) # 1000 experimentos com 10 tentativas e p = 0.5
p2 <- ggplot2::ggplot(data.frame(binomial_data), ggplot2::aes(x = binomial_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Binomial (n = 10, p = 0.5)", x = "Número de Sucessos", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p3 <- ggplot2::ggplot(data.frame(geom_data), ggplot2::aes(x = geom_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Geométrica (p = 0.5)", x = "Número de Tentativas até o Sucesso", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
neg_binomial_data <- rnbinom(1000, 3, 0.5) # número de tentativas até o 3º sucesso
p4 <- ggplot2::ggplot(data.frame(neg_binomial_data), ggplot2::aes(x = neg_binomial_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Binomial Negativa (r = 3, p = 0.5)", x = "Número de Tentativas até o 3º Sucesso", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
hypergeom_data <- rhyper(1000, 10, 30, 5) # 1000 amostras de tamanho 5 sem reposição
p5 <- ggplot2::ggplot(data.frame(hypergeom_data), ggplot2::aes(x = hypergeom_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Hipergeométrica (m = 10, n = 30, k = 5)", x = "Número de Sucessos", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
poisson_data <- rpois(1000, 3) # 1000 eventos com taxa lambda = 3
p6 <- ggplot2::ggplot(data.frame(poisson_data), ggplot2::aes(x = poisson_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Poisson (λ = 3)", x = "Número de Eventos", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
uniform_data <- sample(1:6, 1000, replace = TRUE) # 1000 resultados de uma distribuição uniforme discreta (dados de 1 a 6)
p7 <- ggplot2::ggplot(data.frame(uniform_data), ggplot2::aes(x = uniform_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Uniforme Discreta", x = "Resultado", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p8 <- ggplot2::ggplot(multinomial_df, ggplot2::aes(x = factor(Result), y = Freq)) +
  ...
  ggplot2::labs(title = "Distribuição Multinomial", x = "Resultado", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )

# Criar painel 2x4 com todos os gráficos, incluindo o p8
...
```{r distribuicao-basica, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições contínuas básicas e suas funções de densidade."}
set.seed(42)
...
uniforme_data <- runif(1000000, min = 0, max = 1) # 1000000 valores amostrados entre 0 e 1
p1 <- ggplot2::ggplot(data.frame(uniforme_data), ggplot2::aes(x = uniforme_data)) +
  ...
  ggplot2::labs(title = "Distribuição Uniforme (a = 0, b = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
exponencial_data <- rexp(1000000, rate = 1) # 1000000 valores amostrados com lambda = 1
p2 <- ggplot2::ggplot(data.frame(exponencial_data), ggplot2::aes(x = exponencial_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Exponencial (lambda = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gridExtra::grid.arrange(p1, p2, ncol = 2, nrow = 1) # Arranjo 1 linha e 2 colunas
```

<br>

```{r distribuicao-simetricas, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições contínuas aproximadas e suas funções de densidade."}
set.seed(42)
...
normal_data <- rnorm(100000, mean = 0, sd = 1) # 100000 valores amostrados de uma normal
p3 <- ggplot2::ggplot(data.frame(normal_data), ggplot2::aes(x = normal_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Normal (mu = 0, sigma = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gridExtra::grid.arrange(p3, ncol = 1, nrow = 1) # Arranjo 1 linha e 1 coluna
```

<br>

```{r distribuicao-aproximada, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições contínuas aproximadas e suas funções de densidade."}
...
binomial_data <- rbinom(100000, size = 100, prob = 0.5) # 100000 amostras com n = 100 e p = 0.5
p4 <- ggplot2::ggplot(data.frame(binomial_data), ggplot2::aes(x = binomial_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Aproximação Binomial (n = 100000, p = 0.5)", x = "Número de Sucessos", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
poisson_data <- rpois(100000, lambda = 5) # 100000 amostras com lambda = 5
p5 <- ggplot2::ggplot(data.frame(poisson_data), ggplot2::aes(x = poisson_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Poisson (lambda = 5)", x = "Número de Ocorrências", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gridExtra::grid.arrange(p4, p5, ncol = 2, nrow = 1) # Arranjo 1 linha e 2 colunas
```

<br>

```{r distribuicao-inferencia, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições contínuas para inferência e suas funções de densidade."}
...
tstudent_data <- rt(100000, df = 10) # 100000 amostras com df = 10
p6 <- ggplot2::ggplot(data.frame(tstudent_data), ggplot2::aes(x = tstudent_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição t-Student (df = 10)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
chi_squared_data <- rchisq(100000, df = 10) # 100000 amostras com df = 10
p7 <- ggplot2::ggplot(data.frame(chi_squared_data), ggplot2::aes(x = chi_squared_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Qui-Quadrado (df = 10)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gridExtra::grid.arrange(p6, p7, ncol = 2, nrow = 1) # Arranjo 1 linhas e 2 colunas
```

<br>

```{r distribuicao-específicos, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições contínuas para dados específicos e suas funções de densidade."}
...
weibull_data <- rweibull(100000, shape = 1.5, scale = 1) # 100000 amostras com shape = 1.5, scale = 1
p8 <- ggplot2::ggplot(data.frame(weibull_data), ggplot2::aes(x = weibull_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Weibull (shape = 1.5, scale = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gama_data <- rgamma(100000, shape = 5, scale = 1) # 100000 amostras com shape = 5, scale = 1
p9 <- ggplot2::ggplot(data.frame(gama_data), ggplot2::aes(x = gama_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Gama (shape = 5, scale = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
log_normal_data <- rlnorm(100000, meanlog = 0, sdlog = 1) # 100000 amostras com meanlog = 0, sdlog = 1
p10 <- ggplot2::ggplot(data.frame(log_normal_data), ggplot2::aes(x = log_normal_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Log-Normal (meanlog = 0, sdlog = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gridExtra::grid.arrange(p8, p9, p10, ncol = 3, nrow = 1) # Arranjo 1 linhas e 3 colunas
```

<br>

```{r distribuicao-proporcoes, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições contínuas para probabilidades e proporções e suas funções de densidade."}
...
beta_data <- rbeta(100000, shape1 = 2, shape2 = 5) # 100000 amostras com alpha = 2 e beta = 5
p11 <- ggplot2::ggplot(data.frame(beta_data), ggplot2::aes(x = beta_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Beta (alpha = 2, beta = 5)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
logistica_data <- rlogis(100000, location = 0, scale = 1) # 100000 amostras com mu = 0, s = 1
p12 <- ggplot2::ggplot(data.frame(logistica_data), ggplot2::aes(x = logistica_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Logística (mu = 0, s = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gridExtra::grid.arrange(p11, p12, ncol = 2, nrow = 1) # Arranjo 1 linhas e 2 colunas
```

<br>

```{r distribuicao-pareto, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuições contínuas com caudas pesadas e suas funções de densidade."}
...
pareto_data <- actuar::rpareto(100, shape = 2, scale = 1) # 100 amostras com shape = 2 e scale = 1
p13 <- ggplot2::ggplot(data.frame(pareto_data), ggplot2::aes(x = pareto_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Pareto (shape = 2, scale = 1)", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
gridExtra::grid.arrange(p13, ncol = 1, nrow = 1) # Arranjo 1 linhas e 3 colunas
```
...
```{r normalidade-distribuicao, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuição normal e métodos de visualização e testes de normalidade."}
...
```{r nao-normalidade-distribuicao, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Distribuição não-normal (exponencial) e métodos de visualização e testes de normalidade."}

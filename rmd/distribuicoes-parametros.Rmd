...
-   Erro padrão da média (EPM) \@ref(eq:sem).
...
-   Intervalo de confiança \@ref(eq:ic-known) \@ref(eq:ic-unknown): Captura a média populacional correspondente ao nível de significância $\alpha$ pré-estabelecido.[@kanji2006; @Cumming2007; @krzywinski2013; @Ali2016]

\begin{equation}
(\#eq:ic-known)
IC = \bar{x} \pm z_{\alpha/2} \cdot \frac{\sigma}{\sqrt{n}} \tag{eq:ic}
\end{equation}
...
\begin{equation}
(\#eq:ic-unknown)
IC = \bar{x} \pm t_{\alpha/2, n-1} \cdot \frac{s}{\sqrt{n}} \tag{eq:ic}
\end{equation}

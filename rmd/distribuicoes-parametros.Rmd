...
p1 <- ggplot2::ggplot(data.frame(bernoulli_data), ggplot2::aes(x = bernoulli_data)) +
  ...
  ggplot2::labs(title = "Distribuição Bernoulli", x = "Resultado", y = "Frequência") +
...
p2 <- ggplot2::ggplot(data.frame(binomial_data), ggplot2::aes(x = binomial_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Binomial", x = "Número de Sucessos", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p3 <- ggplot2::ggplot(data.frame(geom_data), ggplot2::aes(x = geom_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Geométrica", x = "Número de Tentativas até o Sucesso", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p4 <- ggplot2::ggplot(data.frame(neg_binomial_data), ggplot2::aes(x = neg_binomial_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Binomial Negativa", x = "Número de Tentativas até o 3º Sucesso", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p5 <- ggplot2::ggplot(data.frame(hypergeom_data), ggplot2::aes(x = hypergeom_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Hipergeométrica", x = "Número de Sucessos", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p6 <- ggplot2::ggplot(data.frame(poisson_data), ggplot2::aes(x = poisson_data)) +
  ggplot2::geom_bar(stat = "count", fill = cor_padrao) +
  ggplot2::labs(title = "Distribuição Poisson", x = "Número de Eventos", y = "Frequência") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p1 <- ggplot2::ggplot(data.frame(uniforme_data), ggplot2::aes(x = uniforme_data)) +
  ...
  ggplot2::labs(title = "Distribuição Uniforme", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p2 <- ggplot2::ggplot(data.frame(exponencial_data), ggplot2::aes(x = exponencial_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Exponencial", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p3 <- ggplot2::ggplot(data.frame(normal_data), ggplot2::aes(x = normal_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Normal", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p4 <- ggplot2::ggplot(data.frame(binomial_data), ggplot2::aes(x = binomial_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Aproximação Binomial", x = "Número de Sucessos", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p5 <- ggplot2::ggplot(data.frame(poisson_data), ggplot2::aes(x = poisson_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Poisson", x = "Número de Ocorrências", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p6 <- ggplot2::ggplot(data.frame(tstudent_data), ggplot2::aes(x = tstudent_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição t-Student", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p7 <- ggplot2::ggplot(data.frame(chi_squared_data), ggplot2::aes(x = chi_squared_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Qui-Quadrado", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p8 <- ggplot2::ggplot(data.frame(weibull_data), ggplot2::aes(x = weibull_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Weibull", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p9 <- ggplot2::ggplot(data.frame(gama_data), ggplot2::aes(x = gama_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Gama", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p10 <- ggplot2::ggplot(data.frame(log_normal_data), ggplot2::aes(x = log_normal_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Log-Normal", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p11 <- ggplot2::ggplot(data.frame(beta_data), ggplot2::aes(x = beta_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Beta", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p12 <- ggplot2::ggplot(data.frame(logistica_data), ggplot2::aes(x = logistica_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Logística", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )
...
p13 <- ggplot2::ggplot(data.frame(pareto_data), ggplot2::aes(x = pareto_data)) +
  ggdist::stat_halfeye(fill = cor_padrao, color = "black", alpha = 0.7) + 
  ggplot2::labs(title = "Distribuição Pareto", x = "Valor", y = "Densidade") +
  ggplot2::theme_minimal() +
  ggplot2::theme(
    text = ggplot2::element_text(size = 8)  # Ajuste o tamanho da fonte de todos os elementos
  )

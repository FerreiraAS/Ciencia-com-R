...
df <- tibble::tibble(
  valor = c(dados_normal, dados_assimetrico),
...
g_hist <- ggplot2::ggplot(df, ggplot2::aes(x = valor)) +
  ggplot2::geom_histogram(aes(y = ggplot2::after_stat(density), fill = tipo),
                 bins = 30, alpha = 0.60, color = "white") +
  ggplot2::geom_density(color = "black", linewidth = 1) +
  ggplot2::facet_wrap(~ tipo, scales = "free") +
  ggplot2::geom_vline(data = resumo, ggplot2::aes(xintercept = media), linetype = 2) +
  ggplot2::geom_vline(data = resumo, ggplot2::aes(xintercept = mediana), linetype = 3) +
  ggplot2::labs(

# **Diretrizes e Listas** {#diretrizes-checklists-cap}
...
-   *A Guideline for Reporting Mediation Analyses of Randomized Trials and Observational Studies: The AGReMA Statement*.[@lee2021]
...
## Listas de verificação {#listas-verificacao}

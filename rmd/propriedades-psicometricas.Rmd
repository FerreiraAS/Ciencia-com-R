...
```{r crosstable-psicometria, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE}
library(dplyr)
cross.table.psico <-
  matrix(
    c(
...
```{r crosstable-kappa-2x2, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE}
library(dplyr)
cross.table.kappa <-
  matrix(
    c(
...
```{r crosstable-kappa-3x3, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE}
library(dplyr)
cross.table.kappa <-
  matrix(
    c(

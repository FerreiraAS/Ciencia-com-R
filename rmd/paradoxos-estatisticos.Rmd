...
-   Ao estimar simultaneamente 3 ou mais médias de variáveis normais independentes (com perda quadrática), o estimador $X_i$ (ótimo para cada média isoladamente) deixa de ser ótimo no conjunto, existindo estimadores que têm erro médio total menor.[@stein1956;@james_estimation_1961]

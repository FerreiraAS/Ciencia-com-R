...
### Quais são as melhores práticas em simulações computacionais?
...
- Não. Simulações computacionais não dependem da distribuição Normal. 
  Qualquer distribuição de probabilidade pode ser usada para gerar dados artificiais, desde que represente adequadamente o mecanismo gerador do fenômeno em estudo.[@REF]

...
```{r aprendizagem-maquina, include = TRUE, echo = FALSE, warning = FALSE, message = FALSE,fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Mapa mental de algoritmos de aprendizado de máquina.", out.width = "100%"}

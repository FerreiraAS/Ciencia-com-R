...
# **Tamanho de efeito** {#tamanho-efeito}
...
-   Tamanho de efeito quantifica a magnitude de um efeito real da análise, expressando uma importância descritiva dos resultados.[@Kim2015]
...
### Quais são os tipos de tamanho de efeito?

-   Diferenças padronizadas entre grupos: Cohen's $d$, Glass's $\Delta$, razão de chances ($RC$ ou $OR$), risco relativo ou razão de risco ($RR$).[@Sullivan2012; @Kim2015]

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *epitools*[@epitools] fornece a função `oddsratio.wald` para calcular a razão de chances.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *epitools*[@epitools] fornece a função `riskratio.wald` para calcular a razão de risco.
:::

<br>

-   Medidas de associação: coeficiente de correlação de Pearson ($r$), ponto-bisserial ($r_{s}$), Spearman ($\rho$), Kendall ($\tau$), Cramér ($V$) e $\phi$.[@Sullivan2012; @Kim2015]

<br>

### Como interpretar um tamanho de efeito?
...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *effectsize*[@effectsize] fornece a função `rules` para criar regras de interpretação de tamanhos de efeito.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *effectsize*[@effectsize] fornece a função `interpret` para interpretar os tamanhos de efeito com base em uma lista de regras pré-definidas.
:::

<br>

::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *pwr*[@pwr] fornece a função `cohen.ES` para obter os tamanhos de efeito "pequeno", "médio" e "grande" para diversos testes de hipóteses.
:::
...
### O que é tamanho de efeito bruto?
...
### O que é tamanho de efeito padronizado?

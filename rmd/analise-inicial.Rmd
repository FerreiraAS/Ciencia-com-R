...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *base*[@base] fornece a função [*duplicated*](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/duplicated) para identificar elementos duplicados de um banco de dados.
:::

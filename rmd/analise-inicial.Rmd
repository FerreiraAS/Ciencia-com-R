...
-   A análise inicial de dados pode ser dividida nas seguintes etapas: Configuração dos metadados; Limpeza dos dados; Verificação dos dados; Relatório inicial dos dados; Refinamento e atualização do plano de análise estatística; Documentação e relatório da análise inicial de dados.[@Baillie2022]
...
O pacote *stats*[@stats] fornece a função `na.omit` para retornar os dados sem os dados perdidos.
:::
...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *base*[@base] fornece a função `duplicated` para identificar elementos duplicados de um banco de dados.
:::

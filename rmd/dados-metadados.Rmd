...
- *Big data* refere-se a bancos de dados muito grandes com um mecanismo "R" --- aleatório (*Random*), auto-reportado (*self-Reported*), reportado administrativamente (*administratively Reported*), seletivamente respondido (*selectively Responded*) ---  descontrolado ou desconhecido.[@meng2018]

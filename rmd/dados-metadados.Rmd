...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *base*[@base-3] fornece a função [*names*](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/names) para declarar o nome de uma variável.
:::
...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *base*[@base-3] fornece a função [*labels*](https://www.rdocumentation.org/packages/base/versions/3.6.2/topics/labels) para declarar o rótulo de uma variável.
:::

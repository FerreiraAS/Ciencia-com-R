...
```{r hot-encoding, echo=FALSE, warning=FALSE, message=FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Codificação one-hot, count encoding e multi-hot encoding."}
library(dplyr)
...
knitr::kable(
  ...
  linesep = "",
  escape = FALSE,
  caption = "Codificação one-hot, multi-hot e count encoding para representação de texto."
) %>%

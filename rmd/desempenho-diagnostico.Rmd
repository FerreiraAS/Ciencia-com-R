...
```{r crosshair, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico *crosshair* em espaço ROC (Receiver Operating Characteristic) para 15 estudos simulados de desempenho diagnóstico."}
# Reprodutibilidade
set.seed(123)

...
- Razão de verossimilhança positiva ($LR+$), equação \@ref(eq:lrplus): Quantifica o quanto a probabilidade de a condição estar presente aumenta quando o teste é positivo.[@REF]
...
- Razão de verossimilhança negativa ($LR-$), equação \@ref(eq:lrminus): Quantifica o quanto a probabilidade de a condição estar presente diminui quando o teste é negativo.[@REF]
...
-   Acurácia ($ACU$), equação \@ref(eq:acu): Proporção de casos e controles corretamente identificados.[@greenhalgh1997b]
...
-   Razão de chances diagnóstica ($DOR$), equações \@ref(eq:dor1), \@ref(eq:dor2) e \@ref(eq:dor3): Razão entre a chance de um teste ser positivo quando a condição está presente e a chance de um teste ser positivo quando a condição está ausente.[@Glas2003]

...
- Gráficos de cruzes ou mira (*crosshair*).[@REF]
...
# ---- ggplot crosshair in ROC space ----
p <- ggplot2::ggplot(df, ggplot2::aes(x = fpr, y = sens)) +
  ggplot2::geom_errorbar(ggplot2::aes(ymin = sens_low, ymax = sens_up), width = 0.008, alpha = 0.8) +
  ggplot2::geom_errorbarh(ggplot2::aes(xmin = fpr_low, xmax = fpr_up), height = 0.008, alpha = 0.8) +
  ggplot2::geom_point(aes(size = size_pt), shape = 21, fill = "gray20", color = "white") +

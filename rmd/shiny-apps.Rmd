...
```{r RCTapp, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", out.width = "100%", fig.cap = "RCTapp: Shiny app para análise de ensaios clínicos aleatorizados."}

...
```{r RCTapp, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "RCTapp: Shiny app para análise de ensaios clínicos aleatorizados."}

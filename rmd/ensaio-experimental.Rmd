...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *consort*[@consort] fornece a função [*consort_plot*](`r paste0("https://search.r-project.org/CRAN/refmans/", "consort", "/html/", "consort_plot", ".html")`) para elaboração do fluxograma de ensaios experimentais no formato padrão.
:::

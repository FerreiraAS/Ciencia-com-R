...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *performance*[@performance] fornece a função `check_model` para analisar a colinearidade entre variáveis, a normalidade da distribuição das variáveis e a heteroscedasticidade.
:::
...
- Testes não paramétricos fazem suposições sobre a forma da distribuição, as características e/ou parâmetros da distribuição dos dados na população.[@Ali2016; @vetter2017]
...
- Quando as suposições são atendidas, testes paramétricos tendem a apresentar maior poder estatístico que testes não-paramétricos correspondentes.[@greenhalgh1997; @schmider2010; @vetter2017]

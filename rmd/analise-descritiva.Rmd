...
- Tabela de contingência (ou tabela cruzada): cruza duas variáveis categóricas, permitindo observar possíveis associações entre elas; base para testes como qui-quadrado.[@REF]
...
- Tabela de comparação entre grupos: apresenta médias, desvios padrão e resultados de testes estatísticos (como t de Student, ANOVA, Mann-Whitney) para comparar dois ou mais grupos.[@REF]

- Tabela de resultados de testes estatísticos: exibe valores de estatísticas de teste (como t, F, χ²), valores de p e intervalos de confiança; usada para mostrar inferências.[@REF]

- Tabela de regressão (ou de modelos estatísticos): mostra os coeficientes de regressão, erros padrão, intervalos de confiança e valores de p para cada variável de um modelo (ex: regressão linear, logística, modelos mistos).[@REF]
...
```{r graficos-var-categoricas, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico de barras simples representando frequências por categoria."}
...
```{r graficos-var-categoricas-empilhados, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico de barras empilhadas representando frequências por categoria."}
# Criar um conjunto de dados de exemplo
dados <- data.frame(
  Grupo = rep(c("A", "B", "C"), each = 3),
  Categoria = rep(c("X", "Y", "Z"), times = 3),
...
- Gráfico de linha: Usado para séries temporais (ex: evolução de uma medida ao longo do tempo).[@REF]

<br>

```{r graficos-var-numericas, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Histograma da variável 'valor'."}
# Simular dados
...
```{r boxplot-grupos, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Boxplot por grupo."}
...
```{r grafico-densidade, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico de densidade da variável 'valor'."}
# Simular dados
...
```{r graficos-relacoes, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico de dispersão representando a relação entre duas variáveis."}
# Simular dados
dados <- data.frame(
...
```{r graficos-bolhas, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico de bolhas representando a relação entre três variáveis."}
...
```{r grafico-linha, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico de linha representando uma série temporal."}
...
- Gráfico de correlação: Representa a relação entre duas variáveis, com pontos e uma linha de tendência.[@REF]

- Gráfico de calor (*heatmap*): Representa dados em uma matriz, com cores indicando intensidade ou frequência.[@REF]

<br>

```{r graficos-multivariados, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico radar representando múltiplas variáveis."}
...
```{r graficos-matriz-dispersao, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Matriz de dispersão representando relações entre múltiplas variáveis."}
...
```{r graficos-correlacao, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Gráfico de correlação entre duas variáveis com linha de tendência."}
...
```{r graficos-heatmap, echo = FALSE, warning = FALSE, message = FALSE, appendix = TRUE, fig.align = 'center', results = "asis", fig.fullwidth = TRUE, fig.cap = "Mapa de calor da correlação entre variáveis."}

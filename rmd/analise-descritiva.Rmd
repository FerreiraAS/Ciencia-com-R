...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *gtsummary*[@gtsummary-2] fornece a função [*tbl_summary*](https://www.rdocumentation.org/packages/gtsummary/versions/1.6.3/topics/tbl_summary) para construção da 'Tabela 2'.
:::

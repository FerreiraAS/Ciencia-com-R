...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *esquisse*[@esquisse] fornece a função `esquisser` para executar uma interface interativa para visualização de dados.
:::
...
-   Para medidas de variabilidade: use 1–2 dígitos significativos.[@Weissgerber2019]

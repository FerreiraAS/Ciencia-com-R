...
-   As funções de ativação introduzem não-linearidades nas redes neurais, permitindo que aprendam padrões complexos, tais como a sigmoide \@ref(eq:sigmoide), ReLU \@ref(eq:relu) e tangente hiperbólica \@ref(eq:tanh).[@REF]

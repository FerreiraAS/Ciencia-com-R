...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *performance*[@performance-2] fornece a função [*check_dag*](https://easystats.github.io/performance/reference/check_dag.html) para criar, verificar e visualizar os modelos em grafos.
:::

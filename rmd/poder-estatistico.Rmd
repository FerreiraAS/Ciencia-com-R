...
::: {.infobox .Rlogo data-latex="{images/Rlogo}"}
O pacote *Superpower*[@Superpower] fornece a função [*power_oneway_within*](https://www.rdocumentation.org/packages/Superpower/versions/0.2.0/topics/power_oneway_within) para calcular o poder do teste por análise de variância (ANOVA) de 1 fator intraindivíduos.
:::

...
```{r correlacao, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", out.width = "100%", fig.cap = "Exemplo de diferentes forças e direção de correlação entre duas variáveis X e Y."}
...
```{r anscombe-data, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", out.width = "100%"}
library(dplyr)
...
```{r anscombe-plot, echo = FALSE, warning = FALSE, message = FALSE, fig.align = 'center', results = "asis", out.width = "100%", fig.cap = "Gráfico de dispersão do Quarteto de Anscombe para representação gráfica de conjuntos de dados bivariados com parâmetros quase idênticos e relações muito distintas."}
library(dplyr)
anscombe.dt <- datasets::anscombe
anscombe.dt$ID <- seq(1, dim(anscombe.dt)[1])
...
### Por que a colinearidade prejudica a modelagem estatística?

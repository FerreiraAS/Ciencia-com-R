...
```{r cca-example, echo=FALSE, warning=FALSE, message=FALSE, appendix=TRUE, fig.align = 'center', layout='Blank', ph=officer::ph_location_fullsize(), results = "asis", fig.fullwidth = TRUE, fig.cap = "Exemplo de análise de correlação canônica (CCA) entre dois conjuntos de variáveis."}
# Reproducibilidade
set.seed(123)

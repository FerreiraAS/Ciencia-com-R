...
```{r post, echo = FALSE, include = FALSE}
# source scripts
source(file.path("posts", "parseRmd.R"), local = knitr::knit_global())
source(file.path("posts", "savePost.R"), local = knitr::knit_global())
...
#   entries <- ParseRmdContent(rmd_files, bib, k)
# }
```

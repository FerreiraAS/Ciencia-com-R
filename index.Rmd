...
rmd_files <- rmd_files[!grepl("shiny-apps.Rmd", rmd_files)]
rmd_files <- rmd_files[!grepl("fontes-externas.Rmd", rmd_files)]
rmd_files <- rmd_files[!grepl("diretrizes-listas.Rmd", rmd_files)]

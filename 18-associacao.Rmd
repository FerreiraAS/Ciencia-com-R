...
### Quais testes podem ser usados em análise de associação?
...
```{r tabelas-2x2, echo = TRUE, include = TRUE, results = "asis", warning = FALSE, message = FALSE, fig.align = 'center'}
library("dplyr")
library("gtsummary")
...
```{r tabelas-NxM, echo = TRUE, include = TRUE, results = "asis", warning = FALSE, message = FALSE, fig.align = 'center'}
library("dplyr")
library("gtsummary")

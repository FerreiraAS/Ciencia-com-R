...
### Quais testes podem ser usados em análise de associação bivariável?
...
```{r, echo = TRUE, include = TRUE, results = "asis", warning = FALSE, message = FALSE, fig.align = 'center'}
# carrega os pacotes
library("dplyr")
library("gtsummary")
...
-   a análise multivariável consiste em uma variável dependente e múltiplas variáveis dependentes.[@Hidalgo2013]

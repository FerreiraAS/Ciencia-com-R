...
::: {style="color: blue;"}
`r library(fontawesome); fa("r-project", margin_right = "0.1em")` O pacote *stats*[@stats-2] fornece a função *cor.test* para calcular o coeficiente de correlação de Spearman $\rho$. [`r library(fontawesome); fa("up-right-from-square", margin_right = "0.1em")`](https://rdocumentation.org/packages/stats/versions/3.6.2)
:::

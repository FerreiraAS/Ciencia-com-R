...
kableExtra::kable(head(table.1, n = 10L), align = "c", format = "html", booktabs = TRUE) %>%
...
# exibe as 10 linhas iniciais da tabela de dados
kableExtra::kable(head(table.2, n = 10L), align = "c", format = "html", booktabs = TRUE) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
# exibe as 10 linhas iniciais da tabela de dados
kableExtra::kable(head(table.3, n = 10L), align = "c", format = "html", booktabs = TRUE) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
# exibe as 10 linhas iniciais da tabela de dados
kableExtra::kable(head(table.4, n = 10L), align = "c", format = "html", booktabs = TRUE) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
# exibe as 10 linhas iniciais da tabela de dados
kableExtra::kable(head(table.5, n = 10L), align = "c", format = "html", booktabs = TRUE) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"
...
# exibe as 10 linhas iniciais da tabela de dados
kableExtra::kable(head(table.6, n = 10L), align = "c", format = "html", booktabs = TRUE) %>%
  kableExtra::kable_styling(
    bootstrap_options = c("striped", "hover", "condensed", "responsive"),
    full_width = T,
    position = "center"

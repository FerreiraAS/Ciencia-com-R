...
\item
  Não utilize cores como informação. Se necessário, crie colunas adicionais - variáveis instrumentais ou auxiliares - para identificar a infomação de modo que possa ser analisada.\textsuperscript{\protect\hyperlink{ref-broman2018}{47}}
\item
...
\tightlist
\item
  Tabelas complementam o texto (e vice-versa), e podem apresentar os dados de modo mais acessível e informativo.\textsuperscript{\protect\hyperlink{ref-Inskip2017}{55}}
\end{itemize}
...
\begin{itemize}
\item
  A Tabela 1 geralmente é utilizada para descrever as características da amostra estudada, possibilitando a análise de ameaças à validade interna e/ou externa ao estudo.\textsuperscript{\protect\hyperlink{ref-Hayes-Larson2019}{56}}
\item
  Inclua na tabela: título ou legenda, uma síntese descritiva (geralmente por meio de parâmetros descritivos), intervalos de confiança e/ou p-valores conforme necessário para adequada interpretação.\textsuperscript{\protect\hyperlink{ref-Inskip2017}{55},\protect\hyperlink{ref-Kwak2021}{57}}
\end{itemize}

\includegraphics[width=1.13em,height=1em]{R-Book_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} O pacote \emph{table1}\textsuperscript{\protect\hyperlink{ref-table1}{58}} fornece funções para construção da `Tabela 1' \href{https://cran.r-project.org/web/packages/table1/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\tightlist
\item
  A Tabela 2 pode ser utilizada para apresentar estimativas de mutiplos efeitos ajustados de um mesmo modelo estatístico.\textsuperscript{\protect\hyperlink{ref-Westreich2013}{59}}
\end{itemize}

\includegraphics[width=1.13em,height=1em]{R-Book_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} O pacote \emph{table1}\textsuperscript{\protect\hyperlink{ref-table1}{58}} fornece funções para construção da `Tabela 2' \href{https://cran.r-project.org/web/packages/table1/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\tightlist
\item
  Gráficos são utilizados para apresentar dados (geralmente em grande quantidade) de modo mais intuitivo e fácil de compreender.\textsuperscript{\protect\hyperlink{ref-Park2022}{60}}
\end{itemize}
...
\tightlist
\item
  Título, eixos horizontal e vertical com respectivas unidades, escalas em intervalos representativos das variáveis, legenda com símbolos, síntese descritiva dos valores e respectiva margem de erro, conforme necessário para adequada interpretação.\textsuperscript{\protect\hyperlink{ref-Park2022}{60}}
\end{itemize}

\includegraphics[width=1.13em,height=1em]{R-Book_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} Os pacotes \emph{ggplot2}\textsuperscript{\protect\hyperlink{ref-ggplot2}{61}}, \emph{plotly}\textsuperscript{\protect\hyperlink{ref-plotly}{62}} e \emph{corrplot}\textsuperscript{\protect\hyperlink{ref-corrplot}{63}} fornecem funções para construção de gráficos \href{https://cran.r-project.org/web/packages/ggplot2/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}} \href{https://cran.r-project.org/web/packages/plotly/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}} \href{https://cran.r-project.org/web/packages/corrplot/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\begin{itemize}
\item
  Barras de erro ajudam ao autor a apresentar as informações que descrevem os dados (por exmeplo, em uma análise descritiva) ou sobre as inferências ou conclusões tomadas a partir de dados.\textsuperscript{\protect\hyperlink{ref-Cumming2007}{64}}
\item
  Barras de erro mais longas representam mais imprecisão (maiores erros), enquanto barras mais curtas representam mais precisão na estimativa.\textsuperscript{\protect\hyperlink{ref-Cumming2007}{64}}
\item
  Barras de erro descritivas geralmente apresentam a amplitude (mínimo-máximo) ou desvio-padrão.\textsuperscript{\protect\hyperlink{ref-Cumming2007}{64}}
\item
  Barras de erro inferenciais geralmente apresentam o erro-padrão ou intervalo de confiança (por exemplo, de 95\%).\textsuperscript{\protect\hyperlink{ref-Cumming2007}{64}}
\item
  O cumprimento das barras de erro sugerem graficamente a imprecisão dos dados do estudo, uma vez que o valor verdadeiro da população pode estar em qualquer nível do intervalo da barra.\textsuperscript{\protect\hyperlink{ref-Cumming2007}{64}}
\end{itemize}
...
\begin{itemize}
\item
  O tamanho da amostra total e subgrupos, se houver, deve estar descrito na figura ou na sua legenda.\textsuperscript{\protect\hyperlink{ref-Cumming2007}{64}}
\item
  Para análise inferencial de figuras, as barras de erro representadas por erro-padrão ou intervalo de confiança são preferíveis à amplitude ou desvio-padrão.\textsuperscript{\protect\hyperlink{ref-Cumming2007}{64}}
\item
  Evite gráficos de barra e mostre a distribuição dos dados sempre que possível.\textsuperscript{\protect\hyperlink{ref-Weissgerber2019}{65}}
\item
  Exiba os pontos de dados em boxplots.\textsuperscript{\protect\hyperlink{ref-Weissgerber2019}{65}}
\item
  Use \emph{jitter} simétrico em gráficos de pontos para permitir a visualização de todos os dados.\textsuperscript{\protect\hyperlink{ref-Weissgerber2019}{65}}
\item
  Prefira palhetas de cor adaptadas para daltônicos.\textsuperscript{\protect\hyperlink{ref-Weissgerber2019}{65}}
\end{itemize}

\includegraphics[width=1.13em,height=1em]{R-Book_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} O pacote \emph{ggsci}\textsuperscript{\protect\hyperlink{ref-ggsci}{66}} fornece palhetas de cores inspiradas em publicações científicas para uso em gráficos \href{https://cran.r-project.org/web/packages/ggsci/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\begin{itemize}
\item
  Inclua fluxogramas com o delineamento aplicado no estudo.\textsuperscript{\protect\hyperlink{ref-Weissgerber2019}{65}}
\item
  A \href{https://www.equator-network.org}{EQUATOR Network} disponibiliza modelos de fluxogramas para os mais diversos delineamentos de estudo.\textsuperscript{\protect\hyperlink{ref-Altman2008}{67}}
\end{itemize}

\includegraphics[width=1.13em,height=1em]{R-Book_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} O pacote \emph{PRISMA2020}\textsuperscript{\protect\hyperlink{ref-PRISMA2020-2}{68},\protect\hyperlink{ref-PRISMA2020}{69}} fornece funções para elaboração do fluxograma de revisões sistemáticas no formato padrão \href{https://cran.r-project.org/web/packages/PRISMA2020/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\includegraphics[width=1.13em,height=1em]{R-Book_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} O pacote \emph{modelsummary}\textsuperscript{\protect\hyperlink{ref-modelsummary}{71}} fornece as funç˜es \emph{modelsummary} e \emph{modelplot} para gerar tabelas e gráficos de coeficientes de regressão. \href{https://cloud.r-project.org/web/packages/modelsummary/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\tightlist
\item
  Limiares duplos podem ser utilizados para análise de desempenho diagnóstico de testes com distribuição trimodal.\textsuperscript{\protect\hyperlink{ref-ferreira2021}{74}}
\end{itemize}
...
\includegraphics[width=1.13em,height=1em]{R-Book_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} O pacote \emph{metagear}\textsuperscript{\protect\hyperlink{ref-metagear}{98}} fornece funções para condução e análise de revisões sistemáticas \href{https://cran.r-project.org/web/packages/metagear/index.html}{\includegraphics[width=1em,height=1em]{R-Book_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\item
  \emph{Who is in this study, anyway? Guidelines for a useful Table 1}.\textsuperscript{\protect\hyperlink{ref-Hayes-Larson2019}{56}}
\item
...
\item
  \emph{Reveal, Don't Conceal: Transforming Data Visualization to Improve Transparency}.\textsuperscript{\protect\hyperlink{ref-Weissgerber2019}{65}}
\item
...
\begin{itemize}
\item
  Checklists têm sido recomendados para melhorar o relato das análses realizadas, aumentar a transparência do estudo e reprodutibilidade dos achados.\textsuperscript{\protect\hyperlink{ref-Gardner1986}{112}}
\item
...
\item
  Checklists não são suficientes para garantir a qualidade técnica da pesquisa, mas podem conitribuir para a revisão por pares.\textsuperscript{\protect\hyperlink{ref-Mascha2017}{113}}
\end{itemize}
...
We used R version 4.3.1\textsuperscript{\protect\hyperlink{ref-base}{54}} and the following R packages: bookdown v. 0.35\textsuperscript{\protect\hyperlink{ref-bookdown2016}{117},\protect\hyperlink{ref-bookdown2023}{118}}, devtools v. 2.4.5\textsuperscript{\protect\hyperlink{ref-devtools}{119}}, emo v. 0.0.0.9000\textsuperscript{\protect\hyperlink{ref-emo}{120}}, fontawesome v. 0.5.2\textsuperscript{\protect\hyperlink{ref-fontawesome}{121}}, kableExtra v. 1.3.4.9000\textsuperscript{\protect\hyperlink{ref-kableExtra}{122}}, knitr v. 1.43\textsuperscript{\protect\hyperlink{ref-knitr2014}{123}--\protect\hyperlink{ref-knitr2023}{125}}, remotes v. 2.4.2.1\textsuperscript{\protect\hyperlink{ref-remotes}{126}}, rmarkdown v. 2.24\textsuperscript{\protect\hyperlink{ref-rmarkdown2018}{127}--\protect\hyperlink{ref-rmarkdown2023}{129}}, tidyverse v. 2.0.0\textsuperscript{\protect\hyperlink{ref-tidyverse}{130}}, webshot v. 0.5.5\textsuperscript{\protect\hyperlink{ref-webshot}{131}}.

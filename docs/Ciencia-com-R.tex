...
\item
  ...
  \begin{itemize}
  \item
    \emph{Source/Script editor}: para edição de R scripts.\textsuperscript{\protect\hyperlink{ref-introduc2020}{30}}
  \item
    \emph{Console}: para execução de códigos simples, .\textsuperscript{\protect\hyperlink{ref-introduc2020}{30}}
  \item
    \emph{Environments}: para visualização de objetos criados durante a sessão de trabalho.\textsuperscript{\protect\hyperlink{ref-introduc2020}{30}}
  \item
    \emph{Output}: para visualização de gráficos criados durante a sessão de trabalho.\textsuperscript{\protect\hyperlink{ref-introduc2020}{30}}
  \end{itemize}
\end{itemize}

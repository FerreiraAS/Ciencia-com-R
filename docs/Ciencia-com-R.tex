...
\subsection{O que um gráfico de cruzes?}\label{o-que-um-gruxe1fico-de-cruzes}

\begin{itemize}
\item
  Gráficos de cruzes ou mira (\emph{crosshair}).\textsuperscript{\citeproc{ref-REF}{\textbf{REF?}}}
\item

...
\begin{itemize}
\item
  a análise multivariável consiste em 1 variável dependente e múltiplas variáveis dependentes.\textsuperscript{\protect\hyperlink{ref-Hidalgo2013}{84}}
\item
  A análise multivariada consiste em múltiplas variáveis dependentes.\textsuperscript{\protect\hyperlink{ref-Hidalgo2013}{84}}
\end{itemize}

\includegraphics[width=1.13em,height=1em]{Ciência-com-R_files/figure-latex/fa-icon-743c64b9ba893ee22ddca6ba87c98316.pdf} O pacote \emph{modelsummary}\textsuperscript{\protect\hyperlink{ref-modelsummary}{85}} fornece as funç˜es \emph{modelsummary} e \emph{modelplot} para gerar tabelas e gráficos de coeficientes de regressão. \href{https://cloud.r-project.org/web/packages/modelsummary/index.html}{\includegraphics[width=1em,height=1em]{Ciência-com-R_files/figure-latex/fa-icon-816f2f8c5de1688221ea8be20e4de069.pdf}}
...
\begin{itemize}
\item
  Seleção bivariada de variáveis - isto é, aplicação de testes de correlação em pares de variáveis candidatas e variável de desfecho afim de selecionar quais serão incluídas no modelo multivariável - é um dos erros mais comuns na literatura.\textsuperscript{\protect\hyperlink{ref-Dales1978}{86},\protect\hyperlink{ref-Sun1996}{87}}
\item
  A seleção bivariada de variáveis torna o modelo mais suscetível a otimismo no ajuste se as variáveis de confundimento não são adequadamente controladas.\textsuperscript{\protect\hyperlink{ref-Dales1978}{86},\protect\hyperlink{ref-Sun1996}{87}}
\end{itemize}
...
\begin{itemize}
\item
  Verifique a existência de multicolinearidade entre as variáveis candidatas.\textsuperscript{\protect\hyperlink{ref-Sun1996}{87}}
\item
  Em caso de uma proporção baixa entre o número de participantes e de variáveis, use o conhecimento prévio da literatura para selecionar um pequeno conjunto de variáveis candidatas.\textsuperscript{\protect\hyperlink{ref-Sun1996}{87}}
\item
  Colapse categorias com contagem nula (células com valor igual a 0) de variáveis candidatas.\textsuperscript{\protect\hyperlink{ref-Sun1996}{87}}
\item
  Use simulações de dados para identificar qual(is) variável(is) está(ão) causando problemas de convergência do ajuste do modelo.\textsuperscript{\protect\hyperlink{ref-Sun1996}{87}}
\end{itemize}

\hypertarget{testes-de-associauxe7uxe3o}{%
\section{Testes de associação}\label{testes-de-associauxe7uxe3o}}

\hypertarget{quais-testes-podem-ser-usados-em-anuxe1lise-de-associauxe7uxe3o}{%
\subsection{Quais testes podem ser usados em análise de associação?}\label{quais-testes-podem-ser-usados-em-anuxe1lise-de-associauxe7uxe3o}}
...
\item
  ...
  \begin{itemize}
  \item
    O teste qui-quadrado (\(\chi^2\)) avalia uma hipótese global se a relação entre duas variáveis e/ou fatores é independente ou associada.\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88}}
  \item
    O teste qui-quadrado é utilizado para comparar a distribuição de uma variável categórica em uma amostra ou grupo com a distribuição em outro. Se a distribuição da variável categórica não for muito diferente nos diferentes grupos, pode-se concluir que a distribuição da variável categórica não está relacionada com a variável dos grupos. Pode-se também concluir que a variável categórica e os grupos são independentes.\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88}}
  \item
    Tipo: não paramétrico.\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88},\protect\hyperlink{ref-McHugh2013}{89}}
  \item
    Suposições:\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88},\protect\hyperlink{ref-McHugh2013}{89}}
    ...
    \end{itemize}
  \item
    Hipóteses:\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88}}
    ...
    \end{itemize}
  \item
    Tamanho do efeito:\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88}}
...
\item
  ...
  \begin{itemize}
  \item
    O teste exato de Fisher avalia a hipótese nula de independência aplicando a distribuição hipergeométrica dos números nas células da tabela.\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88}}
  \item
    Hipóteses:\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88},\protect\hyperlink{ref-McHugh2013}{89}}
    ...
    \end{itemize}
  \item
    Tamanho do efeito:\textsuperscript{\protect\hyperlink{ref-Kim2017a}{88},\protect\hyperlink{ref-McHugh2013}{89}}
...
\NormalTok{tbl\_cross\_ex1 }\OtherTok{\textless{}{-}}
...
\NormalTok{    gtsummary}\SpecialCharTok{::}\FunctionTok{bold\_labels}\NormalTok{()}

\NormalTok{tbl\_cross\_ex1}
\end{Highlighting}
\end{Shaded}
...
\hline
 & 0 & 1 & Unknown & **Total**\\
\hline
\_\_Chemotherapy Treatment\_\_ &  &  &  & \\
\hline
Drug A & 67 & 28 & 3 & 98\\
\hline
Drug B & 65 & 33 & 4 & 102\\
\hline
\_\_Total\_\_ & 132 & 61 & 7 & 200\\
\hline
\end{tabular}
...
\CommentTok{\# tabela NxM}
\NormalTok{tbl\_cross\_ex2 }\OtherTok{\textless{}{-}}
\NormalTok{    trial }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    gtsummary}\SpecialCharTok{::}\FunctionTok{tbl\_cross}\NormalTok{(}
        \AttributeTok{row =}\NormalTok{ stage,}
        \AttributeTok{col =}\NormalTok{ trt,}
        \AttributeTok{percent =} \StringTok{"cell"}
\NormalTok{        ) }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    gtsummary}\SpecialCharTok{::}\FunctionTok{add\_p}\NormalTok{() }\SpecialCharTok{\%\textgreater{}\%}
\NormalTok{    gtsummary}\SpecialCharTok{::}\FunctionTok{bold\_labels}\NormalTok{()}

\NormalTok{tbl\_cross\_ex2}
\end{Highlighting}
\end{Shaded}
